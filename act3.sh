...
mv death_star/millemium_falcon/* death_star 
...
mv chewbacca.txt millemium_falcon && mv han_solo.txt millemium_falcon && mv luke_skywalker.txt millemium_falcon && mv princess_leia.txt millemium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv empire/death_star/millemium_falcon rebellion 
